...
PROCESS_COMMAND='convert "$input" -deskew 40% -gravity center -crop 2480x3508+0+0 -colorspace Gray -despeckle -contrast-stretch 2%x98% -trim +repage -threshold 60% "$output"'
